...
class Settings(BaseSettings):
    ...
    METERED_TURN_API_KEY: str | None = None
    ...
    NVIDIA_ASSET_URL: str = "https://api.nvcf.nvidia.com/v2/nvcf/assets"
    NVIDIA_VISION_MAX_TOKENS: int = 2048
    NVIDIA_VISION_TEMPERATURE: float = 0.2
    NVIDIA_VISION_TOP_P: float = 0.9
    NVIDIA_REQUEST_TIMEOUT_SECONDS: float = 60.0
    NVIDIA_INLINE_IMAGE_LIMIT_BYTES: int = 180 * 1024
