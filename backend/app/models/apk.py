...
class ApkRelease(Base):
    ...
    minimum_android_sdk: Mapped[int] = mapped_column(Integer, default=24)
    minimum_supported_version_code: Mapped[int] = mapped_column(Integer, default=1)
    package_name: Mapped[str] = mapped_column(String(120), default="com.autoai.app")
