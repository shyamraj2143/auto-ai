...
class UserNotificationPreference(Base):
    ...
    apk_updates: Mapped[bool] = mapped_column(Boolean, default=True, nullable=False)
    seva_updates: Mapped[bool] = mapped_column(Boolean, default=True, nullable=False)
    payment_updates: Mapped[bool] = mapped_column(Boolean, default=True, nullable=False)
    social_updates: Mapped[bool] = mapped_column(Boolean, default=True, nullable=False)
    created_at: Mapped[datetime] = mapped_column(DateTime, default=datetime.utcnow, nullable=False)
    updated_at: Mapped[datetime] = mapped_column(DateTime, default=datetime.utcnow, onupdate=datetime.utcnow, nullable=False)
