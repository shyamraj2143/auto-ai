...
class APIUsage(Base):
    ...
    cache_status: Mapped[str] = mapped_column(String(16), default="not_applicable", index=True)
    error_code: Mapped[str] = mapped_column(String(64), nullable=True, index=True)
