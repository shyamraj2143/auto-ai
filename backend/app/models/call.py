...
class UserDevice(Base):
    ...
    permissions_status: Mapped[str] = mapped_column(Text, nullable=True)
...
class Call(Base):
    ...
    trace_id: Mapped[str] = mapped_column(String(36), default=lambda: str(uuid.uuid4()), nullable=False)
    failure_code: Mapped[str] = mapped_column(String(32), nullable=True)
