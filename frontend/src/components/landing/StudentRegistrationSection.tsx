...
export function StudentRegistrationSection() {
  ...
  return <section className="student-registration-section" aria-labelledby="student-registration-title">
    <div className="student-registration-card">
      <div className="student-registration-heading">
        ...
        <div><span className="student-registration-eyebrow">QUICK REGISTRATION</span><h2 id="student-registration-title">Student Registration</h2><p>Fill in your details and they will be added to our registration sheet.</p></div>
      </div>
