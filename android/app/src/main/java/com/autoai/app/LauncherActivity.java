...
/** Crash-safe Capacitor entry point. Optional native integrations are isolated so one broken plugin cannot terminate the entire application before the WebView becomes visible. */
public final class LauncherActivity extends BridgeActivity {
